...
export const gradTemplateGroups: GradTemplateGroup[] = [
  ...
  },
  {
    ...
    templates: [
      ...
      {
        title: '商管與財經｜研究計畫書架構模板：研究問題拆解與可行性',
  ...
  },
  {
    ...
    templates: [
      ...
      {
        title: '人文與社會科學｜研究計畫書架構模板：研究問題形成與文獻對話',
