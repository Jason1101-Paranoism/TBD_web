...
const RULES = {
  ...
  B2: [
    ...
    ['先盤點／問題收斂', (t) => hasRe(t, /盤點|收斂|拆解|轉換/)],
    ['節次表含「常見失分」欄', (t, l) => l.some((x) => x.includes('節次') && x.includes('常見失分'))],
    ['方法選用對照', (t) => has(t, '方法選用對照', '方法對照')],
    ['可行性／工作量換算', (t) => has(t, '可行性換算', '工作量換算', '可行性三角度')],
    ['常見失分點專區', (t) => has(t, '常見失分點自我對照', '常見失分寫法')],
    ['送出前檢核', (t) => has(t, '送出前')],
  ],
  'B3-email': [
    ['使用說明第 2 行', (t, l) => usageLine(l)],
