# WORKLOG 歸檔｜2026-07-28 – 2026-08-04

從 `docs/WORKLOG.md` 移出的 10 則，內容原封未改。主檔只留最近 15 則。
2026-08-21 手動歸檔——`archive-docs.js` 的條目判定會把標題含「模板」的條目
判成非條目，在這個 repo 少算 11 則，所以沒有用它。
