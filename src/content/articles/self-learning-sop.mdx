...
Python 入門：[Python.org 官方教程](https://docs.python.org/3/tutorial/) 或 freeCodeCamp 的 Python 課程。學到能寫基本的 for loop 和 function 之後，直接開始做一個小工具，哪怕只是能讀取一個 CSV 檔案並做簡單分析。
...
Kaggle Learn 的 Pandas 課程是最好的起點，有互動練習，真實資料集，課程設計非常務實。學完之後直接找一個你有興趣的開放資料集（台灣政府開放資料平台、Our World in Data）做一個分析。
