...
- **GitHub 作品集**：如果你有 GitHub，確保它呈現的不只是程式碼，而是你的思考過程。每個 Repo 有清楚的 README（說明問題、解法、使用技術、Demo），commit 紀錄能讓人看出專案是怎麼逐步演進的。一份好的 GitHub 作品集，是技術能力和執行力最直接的展示。
...
- **如果你還沒有任何 Side Project**：選一個你真的對它有點好奇的問題，用你現有的技術能力做一個最小版本的東西，把過程記錄下來。不需要完美，但要有頭有尾，有一個可以展示的成果。
